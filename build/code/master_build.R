...
basefinal <- populacao
basefinal <- merge(basefinal, workforce, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, PEA, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, PIA, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocup, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocup, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocup1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocup2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocup3, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocup4, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocup, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocup1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocup2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocup3, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocup4, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco3, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco4, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco6, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco7, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco3, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco4, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco5, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco6, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco7, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupmasc, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupfem, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupmasc, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupfem, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupcor1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupcor2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupcor3, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupcor4, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupcor5, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupcor1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupcor2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupcor3, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupcor4, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupcor5, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupmascor1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupfemcor1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupmascor1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupfemcor1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupmascor2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupfemcor2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupmascor2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupfemcor2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupmascor5, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupfemcor5, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupmascor5, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupfemcor5, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco1masc, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco1fem, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco2masc, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco2fem, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco3masc, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco3fem, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco4masc, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco4fem, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco5masc, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco5fem, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco6masc, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco6fem, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco7masc, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco7fem, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco1masc, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco1fem, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco2masc, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco2fem, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco3masc, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco3fem, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco4masc, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco4fem, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco5masc, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco5fem, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco6masc, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco6fem, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco7masc, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco7fem, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco1cor1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco2cor1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco3cor1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco4cor1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco5cor1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco6cor1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco7cor1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco1cor1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco2cor1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco3cor1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco4cor1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco5cor1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco6cor1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco7cor1, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco1cor2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco2cor2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco3cor2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco4cor2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco5cor2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco6cor2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco7cor2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco1cor2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco2cor2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco3cor2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco4cor2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco5cor2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco6cor2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco7cor2, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco1cor5, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco2cor5, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco3cor5, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco4cor5, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco5cor5, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco6cor5, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, ocupesco7cor5, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco1cor5, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco2cor5, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco3cor5, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco4cor5, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco5cor5, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco6cor5, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desocupesco7cor5, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, informais, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, formais, by = c("UF", "Trimestre","Ano")) 
basefinal <- merge(basefinal, desalentados, by = c("UF", "Trimestre","Ano")) 
